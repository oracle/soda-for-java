...
To get started, you must have a live Oracle database 12.2.0.1 instance (available from [this page]
(http://www.oracle.com/technetwork/database/enterprise-edition/downloads/index.html)).

SODA is also supported on 12.1.0.2 release, available from the same page, with patch 20885778 applied.
