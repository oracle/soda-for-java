...
// END INFEASIBLE
  ...
  public LobInputStream(Blob locator, InputStream in, int limit)
  {
    super(in, limit);
    blocator = locator;
    clocator = null;
  ...
  public LobInputStream(Clob locator, InputStream in, int limit)
  {
    super(in, limit);
    blocator = null;
    clocator = locator;
  ...
  public LobInputStream(NClob locator, InputStream in, int limit)
  {
    super(in, limit);
    blocator = null;
    clocator = null;
