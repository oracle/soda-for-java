...
public class SqlJsonClause
{
    ...
    throws QueryException
  {
    ...
    if (compFunc == REGEX_WRAPPER)
    {
      ...
      if (bval.getType() == ValueTypePair.TYPE_STRING)
      ...
      if (newval != null)
      {
        ...
        if (newval != oldval)
          bval = new ValueTypePair(newval, ValueTypePair.TYPE_STRING);
      }
    }
    ...
    else if (isNumber || bindNumber)
    {
      if (bval.getType() == ValueTypePair.TYPE_STRING)
      {
        try
        {
          ...
          bval = new ValueTypePair(dec, ValueTypePair.TYPE_NUMBER);
        }
    ...
    else if (bindString || isString)
    {
      ...
      if (bval.getType() == ValueTypePair.TYPE_NUMBER)
      {
        ...
        bval = new ValueTypePair(sval, ValueTypePair.TYPE_STRING);
      }
    }
