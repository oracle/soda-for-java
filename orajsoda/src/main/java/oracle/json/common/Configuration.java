/* $Header: xdk/src/java/json/orajsoda/src/main/java/oracle/json/common/Configuration.java /st_xdk_soda1/5 2024/08/02 02:37:36 vemahaja Exp $ */
...
/**
 *  @version $Header: xdk/src/java/json/orajsoda/src/main/java/oracle/json/common/Configuration.java /st_xdk_soda1/5 2024/08/02 02:37:36 vemahaja Exp $
 *  @author  dmcmahon
...
public class Configuration
{
  ...
  /* context parameters */
  public static final String PARAM_UCP_CONFIG      = "ucp_config";
  ...
  public String dbPasswrd = null;
  public int poolSize = DEFAULT_CONNECTIONS;

  private String containerType = null;
  private String ucpConfigDir = null;
  ...
  private synchronized void importParameters(Properties p_params)
  {
    ...
    setUcpConfigParam(p_params.getProperty(PARAM_UCP_CONFIG));
  }
  ...
  public void setUcpConfigParam(String value)
  {
    if (value == null)
      return;
