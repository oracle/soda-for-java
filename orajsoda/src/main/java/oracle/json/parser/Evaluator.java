...
class Evaluator
{
  ...
  static {
    ...
    Operator.put(EvaluatorCode.$nlRegex,      "nl_regex");
    Operator.put(EvaluatorCode.$nlLikeRegex,  "nl_like_regex");
    Operator.put(EvaluatorCode.$nlciRegex,    "nlci_regex");
    Operator.put(EvaluatorCode.$nlciLikeRegex,"nlci_like_regex");
    ...
    Operator.put(EvaluatorCode.$value,        "value");
    ...
    Modifier.put(EvaluatorCode.$mod,       "mod");
    // String targets only
