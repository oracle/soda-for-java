/* $Header: xdk/src/java/json/orajsoda/src/main/java/oracle/json/parser/FindSpecification.java /st_xdk_soda1/4 2024/08/02 02:37:36 vemahaja Exp $ */
...
/**
 *  @version $Header: xdk/src/java/json/orajsoda/src/main/java/oracle/json/parser/FindSpecification.java /st_xdk_soda1/4 2024/08/02 02:37:36 vemahaja Exp $
 *  @author  dmcmahon
...
public class FindSpecification
{
  ...
  public FindSpecification(InputStream inp, JsonFactoryProvider jProvider)
  ...
  private void splitDocuments(JsonParser jParser, JsonFactoryProvider jProvider)
      ...
      if (event == JsonParser.Event.KEY_NAME)
      {
        ...
        if (level == 0)
        {
          if (key.equals("$project"))
          {
            ...
            generator = jProvider.createGenerator(strWriter);
            isProjection = true;
   ...
   * as an array of keys.
   */
  private void parse(InputStream source, JsonFactoryProvider jProvider)
    throws QueryException
  {
    ...
    else
    {
      try
      {
        jParser = jProvider.createParser(source);
        ...
        if (firstEvent == JsonParser.Event.START_OBJECT)
        {
          ...
          splitDocuments(jParser, jProvider);
        }
