/* $Header: xdk/src/java/json/orajsoda/src/main/java/oracle/json/sodacommon/DocumentKeyer.java /st_xdk_soda1/2 2024/07/16 22:56:04 vemahaja Exp $ */
...
/**
 *  @version $Header: xdk/src/java/json/orajsoda/src/main/java/oracle/json/sodacommon/DocumentKeyer.java /st_xdk_soda1/2 2024/07/16 22:56:04 vemahaja Exp $
 *  @author  dmcmahon
...
/* ### This class is currently not used not that there are codecs. */
public class DocumentKeyer
{
  ...
  {
    setInput(str.getBytes(ByteArray.DEFAULT_CHARSET));
  }
